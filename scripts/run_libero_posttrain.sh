...
export SWANLAB_PROJECT=lingbot-va-libero
...
mkdir -p logs
LOGFILE=logs/train_libero_$(date +"%Y%m%d_%H%M%S").log
...
python -m torch.distributed.run \
    ...
    "$@" \
    --resume-from /home/jwhe/linyihan/lingbot-va/train_out/libero_all_posttrain/checkpoints_20260301_131705/checkpoint_step_1000 \
    > ${LOGFILE} 2>&1
