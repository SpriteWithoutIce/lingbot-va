...
va_libero_all_cfg.num_inference_steps = 10
va_libero_all_cfg.video_exec_step = -1
va_libero_all_cfg.action_num_inference_steps = 20
...
inverse_used = [len(va_libero_all_cfg.used_action_channel_ids)] * va_libero_all_cfg.action_dim
